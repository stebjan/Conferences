...
\abstract{The growing electrophysiology research leads to collecting more data and developing new analytic methods and algorithms. Data description and metadata definition is the aim of numerous papers, for complex data analysis, proper medatada definition for analytic methods is also necessary. Metadata description in suitable technology (e.g. Semantic web) enables processing metadata by computers. This allows developing automatic system for data analysis or constructing complex workflows. Because of suitable ontology describing analytic methods does not exist, authors present a custom ontology that is proposed to be discussed within the scientific community. In this paper, the Semantic web technologies are briefly introduced. Then, medatada definition and ontology construction is presented.}
